...
<div className="provider-directory not-prose">
  <a href="/self-hosting/zimaos">
    <img src="/assets/logos/zimaos.png" className="docs-service-icon" alt="" />
    <span>
      <strong>ZimaOS</strong>
      <small>Import a custom app</small>
    </span>
  </a>
  <a href="/self-hosting/casaos">
    <img src="/assets/logos/casaos.svg" className="docs-service-icon" alt="" />
    <span>
      <strong>CasaOS</strong>
      <small>Import a customized app</small>
    </span>
  </a>
  <a href="/self-hosting/coolify">
    <img src="/assets/logos/coolify.svg" className="docs-service-icon" alt="" />
    <span>
      <strong>Coolify</strong>
      <small>Deploy from Git</small>
    </span>
  </a>
  <a href="/self-hosting/dokploy">
    <img src="/assets/logos/dokploy.svg" className="docs-service-icon" alt="" />
    <span>
      <strong>Dokploy</strong>
      <small>Deploy a Compose service</small>
    </span>
  </a>
  <a href="/self-hosting/portainer">
    <img src="/assets/logos/portainer.svg" className="docs-service-icon" alt="" />
    <span>
      <strong>Portainer</strong>
      <small>Create a stack</small>
    </span>
  </a>
  <a href="/self-hosting/dockge">
    <img src="/assets/logos/dockge.svg" className="docs-service-icon" alt="" />
    <span>
      <strong>Dockge</strong>
      <small>Create a managed stack</small>
    </span>
  </a>
  <a href="/self-hosting/nixos">
    <img src="/assets/logos/nixos.svg" className="docs-service-icon" alt="" />
    <span>
      <strong>NixOS</strong>

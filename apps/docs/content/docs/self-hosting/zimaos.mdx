...
Import OpenPost as a ZimaOS custom app with the supplied [Compose file](https://github.com/getopenpost/openpost/blob/main/deploy/zimaos/docker-compose.yml). The image supports x86_64 devices. Other architectures need amd64 emulation.

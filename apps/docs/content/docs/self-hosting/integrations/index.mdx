...
<div className="provider-directory not-prose">
  ...
  <a href="/self-hosting/integrations/pixelfed">
    <img src="/assets/logos/pixelfed.svg" className="docs-provider-icon" alt="" />
    <span>
      <strong>Pixelfed</strong>
      <small>Photo publishing on your server</small>
    </span>
  </a>
  <a href="/self-hosting/integrations/peertube">
    <img src="/assets/logos/peertube.svg" className="docs-provider-icon" alt="" />
    <span>
      <strong>PeerTube</strong>
      <small>Video publishing to a channel</small>
    </span>
  </a>
  <a href="/self-hosting/integrations/lemmy">
    <img src="/assets/logos/lemmy.svg" className="docs-provider-icon" alt="" />
    <span>
      <strong>Lemmy</strong>
      <small>Post to communities</small>
    </span>
  </a>
  <a href="/self-hosting/integrations/piefed">
    <img src="/assets/logos/piefed.svg" className="docs-provider-icon" alt="" />
    <span>

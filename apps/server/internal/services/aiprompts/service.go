...
Write one strong canonical source text and one platform-appropriate rendition for every supplied target. Keep each rendition within its max_characters value.`,
	...
	{Key: platformPromptKey("pixelfed"), Kind: "platform", Platform: "pixelfed", Version: catalogVersion, Default: "Write a photo-first caption that stands on its own. Keep alt text factual. Avoid engagement bait and hashtag piles."},
	{Key: platformPromptKey("peertube"), Kind: "platform", Platform: "peertube", Version: catalogVersion, Default: "Write a clear video title and a description that explains what the viewer will learn or see. Do not invent chapters, links, or upload details."},
	{Key: platformPromptKey("lemmy"), Kind: "platform", Platform: "lemmy", Version: catalogVersion, Default: "Write a discussion title and body that respect the target community. Give enough context to stand alone. Avoid clickbait and promotional shorthand."},
	{Key: platformPromptKey("piefed"), Kind: "platform", Platform: "piefed", Version: catalogVersion, Default: "Write a discussion title and body that respect the target community. Give enough context to stand alone. Avoid clickbait and promotional shorthand."},

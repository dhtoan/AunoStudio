...
func ApplicationContract(provider, connectionMode string) (ProviderAppContract, bool) {
	...
	contracts := map[string]ProviderAppContract{
		...
		providerPeerTube + ":" + ConnectionModeAppPassword: {Provider: providerPeerTube, ConnectionMode: ConnectionModeAppPassword, AdapterBacked: true, BuiltIn: true},
		providerLemmy + ":" + ConnectionModeAppPassword:    {Provider: providerLemmy, ConnectionMode: ConnectionModeAppPassword, AdapterBacked: true, BuiltIn: true},
		providerPieFed + ":" + ConnectionModeAppPassword:   {Provider: providerPieFed, ConnectionMode: ConnectionModeAppPassword, AdapterBacked: true, BuiltIn: true},
...
func normalizeConnectionMode(provider, connectionMode string, app AppConfig) string {
	...
	case providerPeerTube, providerLemmy, providerPieFed:
		return ConnectionModeAppPassword
	default:

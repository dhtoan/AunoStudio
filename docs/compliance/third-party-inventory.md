...
| --- | --- | --- | --- | --- | --- | --- |
| OpenPost | https://github.com/getopenpost/openpost | AGPL-3.0-only | N/A | Subject to AGPL terms | Allowed subject to license obligations | **Bundled foundation**. Preserve license/source obligations and notices. |
| Bang Motion | https://github.com/bangtutorial/bang-motion | MIT | N/A | MIT notice required for copied/derived code | Permissive | Approved for Phase 4 evaluation; not yet vendored at this checkpoint. |

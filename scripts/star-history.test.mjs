...
test("no same-day marker guard gates the refresh", () => {
  assert.doesNotMatch(workflow, /refresh-day/u);
  assert.doesNotMatch(workflow, /readme-assets-refreshed-on/u);
});

test("three daily schedules keep badges fresh", () => {
